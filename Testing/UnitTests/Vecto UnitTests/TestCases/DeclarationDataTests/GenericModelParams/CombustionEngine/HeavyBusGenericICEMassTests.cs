...
public class HeavyBusGenericICEMassTests
{
    ...
    public void TestGenericICEMassCalculation(VehicleCategory category, AxleConfiguration axleConfiguration, FloorType floorType, bool doubleDecker,
