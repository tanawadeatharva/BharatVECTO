...
public class DummyRunVIFWithInterimBusInputDataProvider : IMultistageVIFInputData
{
	...
	public bool IsComplete => this.MultistageJobInputData.JobInputData.InputComplete;

	public IList<string> InvalidEntries => this.MultistageJobInputData.JobInputData.InvalidEntries;
