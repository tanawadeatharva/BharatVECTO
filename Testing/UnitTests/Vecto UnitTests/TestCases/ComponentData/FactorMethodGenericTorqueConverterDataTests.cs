...
public class FactorMethodGenericTorqueConverterDataTests
{
...
Drag                , 3.450 , 1.304 , -1511.22
    */
    ...
    public void TestGenericATPowerSplitTCData()
    {
        var maxEngineTorque = 1120.SI<NewtonMeter>();
        var engineRatedSpeed = 2200.RPMtoRad();
		var ratioFirstGear = 0.69; //1.4492754;
        ...
        Assert.AreEqual(1.57826, tcData.TorqueConverterEntries[idx].TorqueRatio, 1e-2);
