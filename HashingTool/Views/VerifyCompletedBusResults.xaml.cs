...
namespace HashingTool.Views
{
	...
	/// </summary>
	/// 
	public partial class VerifyCompletedBusResults : UserControl
	{
		public VerifyCompletedBusResults()
		{
			InitializeComponent();
		}
		...
		{
			var dialog = new XMLValidationErrorsDialog();
			dialog.XMLErrors = (DataContext as VerifyCompletedBusViewModel).ErrorsAndWarnings;
			dialog.ErrorCount = (DataContext as VerifyCompletedBusViewModel).ErrorCount;
