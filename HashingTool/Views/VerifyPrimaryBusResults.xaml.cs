...
namespace HashingTool.Views
{
	...
	/// </summary>
	/// 
	public partial class VerifyPrimaryBusResults : UserControl
	{
		public VerifyPrimaryBusResults()
		{
			InitializeComponent();
		}
		...
		{
			var dialog = new XMLValidationErrorsDialog();
			dialog.XMLErrors = (DataContext as VerifyPrimaryBusViewModel).ErrorsAndWarnings;
			dialog.ErrorCount = (DataContext as VerifyPrimaryBusViewModel).ErrorCount;
