...
namespace TUGraz.VectoCore.Tests.Utils
{
    ...
    public class SITest
    {
        ...
        [TestMethod]
        public void SI_CheckForEqualUnit()
        {
        ...
        public void SI_CreateConvert()
        {
            ...
            Assert.AreEqual(45.0 / 180.0 * Math.PI, Math.Atan(1).SI<Radian>().Value(), 0.000001);
        }
        ...
        [TestMethod]
        public void SI_Addition_Subtraction()
        {
