...
| *PTO*       | [0/1]  | Flag which defines if the PTO Cycle is active or not. Only used when standing still (v=0[km/h] or stop time > 0[s]). The PTO Cycle itself is defined in the [**Vehicle Editor**](#vehicle-editor).                                                                                                                                                                                                                                                                                                     |
