...
namespace TUGraz.VectoCore.Tests.Integration.ADAS
{
	...
	public class ADASTestsPEV
	{
		...
		public void Class5_E2_NoADAS_CaseJ() => TestPCC(MethodBase.GetCurrentMethod().Name.Split('_').Slice(0, -1).JoinString("_"), MethodBase.GetCurrentMethod().Name.Split('_').Last(),
			...
			(4909, 4955, OutsideSegment, Accelerate),     // len: 46m
			(4955, 4962, OutsideSegment, Roll),           // len: 7m
			...
			(5025, 5053, OutsideSegment, Accelerate),     // len: 28m
			(5053, 5065, OutsideSegment, Roll),           // len: 12m
			(5065, 5457, OutsideSegment, Accelerate),     // len: 392m
			(5457, 5564, OutsideSegment, Coast),          // len: 107m
			(5564, 6081, OutsideSegment, Brake),          // len: 517m
		...
		public void Class5_E2_NoADAS_CrestCoast2() => TestPCC(MethodBase.GetCurrentMethod().Name.Split('_').Slice(0, -1).JoinString("_"), MethodBase.GetCurrentMethod().Name.Split('_').Last(),
			...
			(182, 278, OutsideSegment, Accelerate),       // len: 96m
			(278, 295, OutsideSegment, Roll),             // len: 17m
			(295, 3615, OutsideSegment, Accelerate),      // len: 3320m
