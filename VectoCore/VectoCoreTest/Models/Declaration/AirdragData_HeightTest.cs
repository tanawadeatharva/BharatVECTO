...
public class AirdragData_HeightTest
{
	...
	[TestCase(VehicleCategory.RigidTruck, AxleConfiguration.AxleConfig_4x2, 7450, 5000, VehicleClass.Class1s, 3.6, 7.1, 7.1)]
	[TestCase(VehicleCategory.RigidTruck, AxleConfiguration.AxleConfig_4x2, 9000, 5000, VehicleClass.Class1, 3.6, 7.1, 7.1)]
	[TestCase(VehicleCategory.RigidTruck, AxleConfiguration.AxleConfig_4x2, 12000, 5000, VehicleClass.Class2, 3.75, 8.5, 7.2, 7.2)]
	[TestCase(VehicleCategory.RigidTruck, AxleConfiguration.AxleConfig_4x2, 14000, 5000, VehicleClass.Class3, 3.9, 7.4, 7.4)]
	[TestCase(VehicleCategory.RigidTruck, AxleConfiguration.AxleConfig_4x2, 17000, 5000, VehicleClass.Class4, 4, 9.9, 8.4, 8.4, 8.4, 6.6)]
	[TestCase(VehicleCategory.Tractor, AxleConfiguration.AxleConfig_4x2, 17000, 5000, VehicleClass.Class5, 4, 8.7, 10.2, 8.7, 10.2, 8.7, 7.2)]
	[TestCase(VehicleCategory.RigidTruck, AxleConfiguration.AxleConfig_6x2, 17000, 5000, VehicleClass.Class9, 4, 10, 10.6, 8.5, 10.6, 8.5, 6.7)]
	[TestCase(VehicleCategory.Tractor, AxleConfiguration.AxleConfig_6x2, 12000, 5000, VehicleClass.Class10, 4, 8.8, 10.3, 8.8, 10.3, 7.3)]
	[TestCase(VehicleCategory.RigidTruck, AxleConfiguration.AxleConfig_6x4, 12000, 5000, VehicleClass.Class11, 4, 10, 10.6, 8.5, 10.6, 8.5, 6.7)]
	[TestCase(VehicleCategory.Tractor, AxleConfiguration.AxleConfig_6x4, 12000, 5000, VehicleClass.Class12, 4, 8.8, 10.3, 8.8, 10.3, 7.3)]
	[TestCase(VehicleCategory.RigidTruck, AxleConfiguration.AxleConfig_8x4, 12000, 5000, VehicleClass.Class16, 3.6, 10.5, 11.1, 9, 11.1, 7)]

	[TestCase(VehicleCategory.RigidTruck, AxleConfiguration.AxleConfig_4x2, 6000, 5000, VehicleClass.Class53, 3.5, 5.8, 5.8)]
	[TestCase(VehicleCategory.Van, AxleConfiguration.AxleConfig_4x2, 6000, 5000, VehicleClass.Class54, 2.9, 2.5, 2.5)]
	public void TestHeight_Lorry(VehicleCategory category, AxleConfiguration axleConfiguration,
		double grossVehicleMassRating, double curbWeight, VehicleClass expectedVehicleClass, double expectedHeight, params double[] expectedCdxA)
	{
		var segment =
		...
		var airdragInputData = new Mock<IAirdragDeclarationInputData>();
		var imcData = new Mock<IVehicleInMotionChargingDeclaration>();
		imcData.Setup(i => i.Technology).Returns(IMCTechnology.GroundRail);
		
		var data = segment.Missions.Select(m => dao.Object.CreateAirdragData(airdragInputData.Object, imcData.Object, m, segment, OvcHevMode.NotApplicable)).ToArray();
    ...
    public void TestHeight_PrimaryBus(AxleConfiguration axleConfiguration, bool articulated, VehicleClass testClass, VehicleClass expectedVehicleClass, double expectedHeight, params double[] expectedCdxA)
	{
		...
		var data = segment.Missions.Where(m => m.BusParameter.BusGroup == testClass).Select(m => dao.Object.CreateAirdragData(airdragInputData.Object, imcData.Object, m, segment, OvcHevMode.NotApplicable)).ToArray();
	...
	[TestCase(AxleConfiguration.AxleConfig_4x2, VehicleCode.CE, RegistrationClass.I, 0, 3, false, VehicleClass.Class31a, 3 + 0.3, 4.9, 4.9, 4.9)]
	[TestCase(AxleConfiguration.AxleConfig_4x2, VehicleCode.CA, RegistrationClass.III, 0, 3, false, VehicleClass.Class32d, 3 + 0.3, 4.6, 4.6)]
	[TestCase(AxleConfiguration.AxleConfig_6x2, VehicleCode.CG, RegistrationClass.A, 0, 3, true, VehicleClass.Class35b1, 3 + 0.3, 5.1, 5.1, 5.1)]
	[TestCase(AxleConfiguration.AxleConfig_8x2, VehicleCode.CC, RegistrationClass.II_III, 0, 3, false, VehicleClass.Class40b, 3 + 0.3, 4.9, 4.9)]
	public void TestHeight_CompleteSpecificBus(AxleConfiguration axleConfiguration, VehicleCode? vehicleCode,
		RegistrationClass? registrationClass, int? passengerCnt, double bodyHeight, bool? lowEntry,
