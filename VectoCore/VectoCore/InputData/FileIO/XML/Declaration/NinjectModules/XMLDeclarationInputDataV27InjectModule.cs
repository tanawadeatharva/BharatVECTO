...
namespace TUGraz.VectoCore.InputData.FileIO.XML.Declaration.NinjectModules
{
    public class XMLDeclarationInputDataV27InjectModule : NinjectModule
    {
        public override void Load()
        {
            ...
            // Auxiliaries
            Bind<IXMLAuxiliariesDeclarationInputData>().To<XMLDeclarationAuxiliariesLorryDataProviderV27>().Named(
                XMLDeclarationAuxiliariesLorryDataProviderV27.QUALIFIED_XSD_TYPE_CONVENTIONAL);

            Bind<IXMLAuxiliariesDeclarationInputData>().To<XMLDeclarationAuxiliariesLorryDataProviderV27>().Named(
                XMLDeclarationAuxiliariesLorryDataProviderV27.QUALIFIED_XSD_TYPE_PHEV);

            Bind<IXMLAuxiliariesDeclarationInputData>().To<XMLDeclarationAuxiliariesLorryDataProviderV27>().Named(
                XMLDeclarationAuxiliariesLorryDataProviderV27.QUALIFIED_XSD_TYPE_SHEV);

            Bind<IXMLAuxiliariesDeclarationInputData>().To<XMLDeclarationAuxiliariesLorryDataProviderV27>().Named(
                XMLDeclarationAuxiliariesLorryDataProviderV27.QUALIFIED_XSD_TYPE_PEV);

            Bind<IXMLAuxiliariesDeclarationInputData>().To<XMLDeclarationAuxiliariesLorryDataProviderV27>().Named(
                XMLDeclarationAuxiliariesLorryDataProviderV27.QUALIFIED_XSD_TYPE_FCHV);
