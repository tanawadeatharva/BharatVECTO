...
{
    class CompletedBusDimensionsWriter : GroupWriter, IVehicleDeclarationGroupWriter
    {
		public CompletedBusDimensionsWriter(XNamespace writerNamespace) : base(writerNamespace) { }
