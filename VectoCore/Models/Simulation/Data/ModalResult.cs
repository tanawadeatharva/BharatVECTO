...
namespace TUGraz.VectoCore.Models.Simulation.Data
{
	...
	public enum ModalResultField
	{
		...
		[ModalResultField(typeof(int), name: "AA_OverrunFlag [bool]")] AA_OverrunFlag,
		[ModalResultField(typeof(int), name: "AA_EngineIdleFlag [bool]")] AA_EngineIdleFlag,
		[ModalResultField(typeof(int), name: "AA_CompressorFlag [bool]")] AA_CompressorFlag,
